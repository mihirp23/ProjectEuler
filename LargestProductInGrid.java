...
public class LargestProductInGrid 
{
    ...
    {
    	String sGrid = "08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08 " +
        ...
        String [] val = sGrid.split(" ");
        int [][] grid = new int [20][20];
        int counter = 0;
        // convert the grid into a multi-dimensional array
        for (int i = 0; i < 20; i++)
        {
        	for (int j = 0; j < 20;j++)
        	{
        		grid[i][j] = Integer.parseInt(val[counter]);
        		counter++;
        	}
        }
